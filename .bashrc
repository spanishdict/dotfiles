...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@${CHEF_NODENAME:-\h}\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}\u@${CHEF_NODENAME:-\h}:\w\$ '
fi
...
case "$TERM" in
xterm*|rxvt*)
    PS1="\[\e]0;${debian_chroot:+($debian_chroot)}\u@${CHEF_NODENAME:-\h}: \w\a\]$PS1"
    ;;
*)
    ;;
esac
